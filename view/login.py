...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../桌面/text/Library/image/login.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.loginbtn.setIcon(icon)
        self.loginbtn.setObjectName("loginbtn")
        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(240, 210, 93, 28))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../桌面/text/Library/image/reset.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_4.setPixmap(QtGui.QPixmap("../../../../桌面/text/Library/image/book(2).png"))
